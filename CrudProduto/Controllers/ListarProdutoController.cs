...
{
    public class ListarProdutoController : ApiController
    {
        private ProdutoContexto db = new ProdutoContexto();

        // GET: api/ListarProduto
        public IQueryable<Produto> GetProdutos()
        {
            return db.Produtos;
        }

        // GET: api/ListarProduto/5
